...
window.parent._wrap_addFunctionToMap('canvastext.js', 5187, 126492,126560);

  return CanvasText.letters[ch];
}, parseLexemes: function(str) {
window.parent._wrap_addFunctionToMap('canvastext.js', 5190, 126584,127554);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5214, 127572,127689);

  style = style || {};
  return style.size || CanvasText.style.size;
}, descent: function(style) {
window.parent._wrap_addFunctionToMap('canvastext.js', 5218, 127708,127836);

  style = style || {};
  return 7 * (style.size || CanvasText.style.size) / 25;
}, measure: function(str, style) {
window.parent._wrap_addFunctionToMap('canvastext.js', 5222, 127855,128380);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5234, 128405,128960);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5246, 128984,129454);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5258, 129483,129928);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5272, 129950,130683);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5294, 130699,133990);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5372, 134008,134657);

  ctx.drawText = function(text, x, y, style) {
window.parent._wrap_addFunctionToMap('canvastext.js', 5373, 134052,134160);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5376, 134192,134286);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5379, 134320,134420);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5382, 134451,134532);
...
window.parent._wrap_addFunctionToMap('canvastext.js', 5385, 134564,134646);
