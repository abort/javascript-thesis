...
CoolClock.findAndCreateClocks = function() {
  ...
  for (var i = 0; i < canvases.length; i++) {
    ...
    if (fields[0] == 'CoolClock') {
      ...
      new CoolClock({canvasId: canvases[i].id, skinId: fields[1], displayRadius: fields[2], showSecondHand: fields[3] != 'noSeconds', gmtOffset: fields[4], showDigital: fields[5] == 'showDigital', logClock: fields[6] == 'logClock', logClockRev: fields[6] == 'logClockRev'});
    }
  }
};
if (window.jQuery) 
