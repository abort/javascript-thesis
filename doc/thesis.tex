...
\subsection{Scoping}
Scoping is important for the mapping function $V$ which uses $\lambda(\pi, x)$ to find variable $x$ for position $\pi$. An accurate lookup implies a more accurate flow graph. % todo better explanation 
