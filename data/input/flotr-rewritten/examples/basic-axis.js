...
(window.parent._wrap_setLastFunctionCall("basic-axis.js",15,330,363) ||     d1.push([i, 4 + (window.parent._wrap_setLastFunctionCall("basic-axis.js",15,346,361) || Math.pow(i, 1.5))]));
(window.parent._wrap_setLastFunctionCall("basic-axis.js",16,370,397) ||     d2.push([i, (window.parent._wrap_setLastFunctionCall("basic-axis.js",16,382,395) || Math.pow(i, 3))]));
(window.parent._wrap_setLastFunctionCall("basic-axis.js",17,404,437) ||     d3.push([i, i * 5 + 3 * (window.parent._wrap_setLastFunctionCall("basic-axis.js",17,422,435) || Math.sin(i * 4))]));
(window.parent._wrap_setLastFunctionCall("basic-axis.js",18,444,459) ||     d4.push([i, i]));
    if ((window.parent._wrap_setLastFunctionCall("basic-axis.js",19,470,482) || i.toFixed(1)) % 1 == 0) {
(window.parent._wrap_setLastFunctionCall("basic-axis.js",20,499,516) ||       d5.push([i, 2 * i]));
    }
  }
