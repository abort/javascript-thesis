...
(function ($, undefined) {
    ...
    $.extend($.ui.draggable, { version: '1.8.17' });
...
(function ($, undefined) {
    ...
    $.extend($.ui.droppable, { version: '1.8.17' });
...
(function ($, undefined) {
    ...
    $.extend($.ui.resizable, { version: '1.8.17' });
    ...
    $.ui.plugin.add('resizable', 'containment', {
        ...
        resize: function (event, ui) {
            var self = $(this).data('resizable'), o = self.options, ps = self.containerSize, co = self.containerOffset, cs = self.size, cp = self.position, pRatio = self._aspectRatio || event.shiftKey, cop = {
                    top: 0,
                    left: 0
...
(function ($, undefined) {
    ...
    $.extend($.ui.selectable, { version: '1.8.17' });
}(jQuery));
(function ($, undefined) {
    ...
    $.extend($.ui.sortable, { version: '1.8.17' });
}(jQuery));
;
    ...
    $.effects.highlight = function (o) {
        return this.queue(function () {
            var elem = $(this), props = [
                    ...
                    'backgroundColor',
                    'opacity'
                ], mode = $.effects.setMode(elem, o.options.mode || 'show'), animation = { backgroundColor: elem.css('backgroundColor') };
            if (mode == 'hide') {
                animation.opacity = 0;
            }
...
(function ($, undefined) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _checkExternalClick: function (event) {
            ...
            if ($target[0].id != $.datepicker._mainDivId && $target.parents('#' + $.datepicker._mainDivId).length == 0 && !$target.hasClass($.datepicker.markerClassName) && !$target.hasClass($.datepicker._triggerClass) && $.datepicker._datepickerShowing && !($.datepicker._inDialog && $.blockUI) || $target.hasClass($.datepicker.markerClassName) && $.datepicker._curInst != inst)
                $.datepicker._hideDatepicker();
        },
...
(function ($, undefined) {
    ...
    $.fn.position = function (options) {
        ...
        var target = $(options.of), targetElem = target[0], collision = (options.collision || 'flip').split(' '), offset = options.offset ? options.offset.split(' ') : [
                0,
                0
...
(function ($, undefined) {
    ...
    $.extend($.ui.progressbar, { version: '1.8.17' });
}(jQuery));
(function ($, undefined) {
    var numPages = 5;
    ...
    $.extend($.ui.slider, { version: '1.8.17' });
}(jQuery));
(function ($, undefined) {
